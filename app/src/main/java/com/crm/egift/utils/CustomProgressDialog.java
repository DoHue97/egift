...
public class CustomProgressDialog {
    ...
    public Dialog show(Context context, String title) {
        ...
        // Progress Bar Color
        setColorFilter(progressBar.getIndeterminateDrawable(), ResourcesCompat.getColor(context.getResources(), R.color.white, null));
    ...
    class CustomDialog extends Dialog {
        ...
        public CustomDialog(@NonNull Context context, int themeResId) {
            ...
            getWindow().getDecorView().getRootView().setBackgroundResource(R.color.black);
